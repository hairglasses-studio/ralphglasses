...
var canonicalKeys = map[string]keySpec{
	...
	"default_provider":      {Type: "string", AllowedStr: []string{"claude", "gemini", "codex", "antigravity", "openai", "crush", "goose", "amp", "a2a"}},
	"worker_provider":       {Type: "string", AllowedStr: []string{"claude", "gemini", "codex", "antigravity", "openai", "crush", "goose", "amp", "a2a"}},
	...
	"provider":              {Type: "string", AllowedStr: []string{"claude", "gemini", "codex", "antigravity", "openai", "crush", "goose", "amp", "a2a"}},
