	...
	return ToolGroup{
		...
		Tools: []ToolEntry{
			{mcp.NewTool("ralphglasses_session_launch",
				...
				mcp.WithNumber("budget_usd", mcp.Description("Budget in USD — maximum spend for this session. Native for Claude; externally enforced by ralphglasses for Codex and Gemini.")),
				...
				mcp.WithString("allowed_tools", mcp.Description("Comma-separated allowed tools (e.g. Bash,Read,Edit). Supported by Claude and Gemini; unsupported by Codex.")),
				mcp.WithString("system_prompt", mcp.Description("Additional system prompt to append. Native for Claude only; use GEMINI.md or AGENTS.md for Gemini/Codex repo instructions.")),
				mcp.WithString("session_name", mcp.Description("Human-readable session name")),
				mcp.WithString("worktree", mcp.Description("Git worktree isolation (true for auto, or branch name). Supported by Claude and Gemini; unsupported for Codex.")),
