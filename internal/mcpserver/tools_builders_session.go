	...
	return ToolGroup{
		...
		Tools: []ToolEntry{
			{mcp.NewTool("ralphglasses_session_launch",
				...
				mcp.WithNumber("budget_usd", mcp.Description("Budget in USD — maximum spend for this session. Not supported for Codex sessions.")),
				mcp.WithNumber("max_turns", mcp.Description("Maximum conversation turns. Not supported for Codex sessions.")),
				mcp.WithString("agent", mcp.Description("Agent name. Not supported for Codex sessions.")),
				mcp.WithString("allowed_tools", mcp.Description("Comma-separated allowed tools (e.g. Bash,Read,Edit). Not supported for Codex sessions.")),
				mcp.WithString("system_prompt", mcp.Description("Additional system prompt to append. Not supported for Codex sessions.")),
				mcp.WithString("session_name", mcp.Description("Human-readable session name")),
				mcp.WithString("worktree", mcp.Description("Git worktree isolation (true for auto, or branch name). Not supported for Codex sessions.")),
