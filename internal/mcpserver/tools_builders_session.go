	...
	return ToolGroup{
		...
		Tools: []ToolEntry{
			{mcp.NewTool("ralphglasses_session_launch",
				...
				mcp.WithString("provider", mcp.Description("LLM provider: codex (default), claude, gemini, antigravity. Antigravity opens an external interactive handoff instead of a managed streaming session.")),
			...
			{mcp.NewTool("ralphglasses_session_resume",
				...
				mcp.WithString("provider", mcp.Description("LLM provider: codex (default), claude, gemini. Antigravity is launch-only and cannot be resumed through ralphglasses.")),
			...
			{mcp.NewTool("ralphglasses_session_handoff",
				...
				mcp.WithString("target_provider", mcp.Description("Target provider: claude, gemini, codex, antigravity (default: same as source)")),
	...
	return ToolGroup{
		...
		Tools: []ToolEntry{
			...
			{mcp.NewTool("ralphglasses_prompt_improve",
				...
				mcp.WithString("provider", mcp.Description("LLM provider for improvement: openai (default; may also target local Ollama-compatible base URLs), claude, gemini")),
