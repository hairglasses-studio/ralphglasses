	...
	return ToolGroup{
		...
		Tools: []ToolEntry{
			...
			{mcp.NewTool("ralphglasses_session_budget",
				mcp.WithDescription("Get cost/budget info for a session by `id`, update the budget, or reset spend tracking"),
				mcp.WithString("id", mcp.Required(), mcp.Description("Session ID")),
				mcp.WithString("tenant_id", mcp.Description("Workspace tenant ID (default: _default)")),
			...
			{mcp.NewTool("ralphglasses_budget_status",
				mcp.WithDescription("Show aggregate budget status across all sessions, matching the CLI budget status command"),
				mcp.WithString("tenant_id", mcp.Description("Workspace tenant ID (default: _default)")),
