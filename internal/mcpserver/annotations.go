...
var ToolAnnotations = map[string]mcp.ToolAnnotation{
	...
	"ralphglasses_prompt_ab_test":        {Title: "Prompt A/B Test", ReadOnlyHint: boolPtr(true)},
	...
	"ralphglasses_fleet_capacity_plan": {Title: "Fleet Capacity Plan", ReadOnlyHint: boolPtr(true)},
	...
	"ralphglasses_roadmap_prioritize": {Title: "Prioritize Roadmap", ReadOnlyHint: boolPtr(true)},
	...
	"ralphglasses_provider_benchmark":     {Title: "Provider Benchmark", ReadOnlyHint: boolPtr(true)},
