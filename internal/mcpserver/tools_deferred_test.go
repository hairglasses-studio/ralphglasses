...
func TestBuildToolGroups_ExpectedCounts(t *testing.T) {
	...
	// Counts are auto-generated by gen-tool-counts; update with:
	//   go generate ./internal/mcpserver/...  (or: make update-tool-counts)
	expectations := GeneratedToolCounts
	...
	if total != totalExpected {
		t.Errorf("total tools across all groups = %d, want %d (re-run: make update-tool-counts)", total, totalExpected)
	}
}
