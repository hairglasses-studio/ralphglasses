...
func (s *Server) Register(srv *server.MCPServer) {
	...
	// Loop benchmarking and regression gates
	srv.AddTool(mcp.NewTool("ralphglasses_loop_benchmark",
	...
	srv.AddTool(mcp.NewTool("ralphglasses_loop_baseline",
	...
	srv.AddTool(mcp.NewTool("ralphglasses_loop_gates",
	...
	srv.AddTool(mcp.NewTool("ralphglasses_self_improve",
