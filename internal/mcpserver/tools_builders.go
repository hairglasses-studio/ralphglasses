	...
	return ToolGroup{
		...
		Tools: []ToolEntry{
			{mcp.NewTool("ralphglasses_blackboard_query",
				mcp.WithDescription("Query blackboard entries by namespace for fleet worker coordination. Requires fleet server mode."),
			...
			{mcp.NewTool("ralphglasses_blackboard_put",
				mcp.WithDescription("Write an entry to the blackboard for fleet coordination. Requires fleet server mode."),
			...
			{mcp.NewTool("ralphglasses_a2a_offers",
				mcp.WithDescription("List open agent-to-agent task delegation offers. Requires fleet server mode."),
			), s.handleA2AOffers},
			{mcp.NewTool("ralphglasses_cost_forecast",
				mcp.WithDescription("Cost burn rate, anomaly detection, and budget exhaustion ETA. Requires fleet server mode."),
