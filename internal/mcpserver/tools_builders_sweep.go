	...
	return ToolGroup{
		...
		Tools: []ToolEntry{
			{mcp.NewTool("ralphglasses_sweep_generate",
				...
				mcp.WithString("target_provider", mcp.Description("Target model provider for structure style: openai (default openai-style), claude, gemini")),
			...
			{mcp.NewTool("ralphglasses_sweep_launch",
				...
				mcp.WithString("provider", mcp.Description("LLM provider for each repo session: omit/auto for runtime selection, or codex, claude, gemini")),
