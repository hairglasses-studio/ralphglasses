	...
	return ToolGroup{
		...
		Tools: []ToolEntry{
			{mcp.NewTool("ralphglasses_team_create",
				...
				mcp.WithString("lead_agent", mcp.Description("Provider-native agent definition name for the lead session")),
				...
				mcp.WithString("execution_backend", mcp.Description("Worker execution backend: local, fleet, a2a")),
