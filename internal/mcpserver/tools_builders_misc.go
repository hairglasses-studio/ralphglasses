	...
	return ToolGroup{
		...
		Tools: []ToolEntry{
			{mcp.NewTool("ralphglasses_team_create",
				...
				mcp.WithString("provider", mcp.Description("LLM provider for lead: codex (default), claude, gemini, ollama")),
				mcp.WithString("worker_provider", mcp.Description("Default LLM provider for worker tasks: codex (default), claude, gemini, ollama")),
			...
			{mcp.NewTool("ralphglasses_team_delegate",
				...
				mcp.WithString("provider", mcp.Description("LLM provider override for this task: claude, gemini, codex, ollama")),
			...
			{mcp.NewTool("ralphglasses_agent_define",
				...
				mcp.WithString("provider", mcp.Description("Target provider: codex (default, .codex/agents/*.toml), claude or ollama (.claude/agents/), gemini (.gemini/agents/*.md)")),
			...
			{mcp.NewTool("ralphglasses_agent_list",
				...
				mcp.WithString("repo", mcp.Required(), mcp.Description("Repo name")),
				mcp.WithString("provider", mcp.Description("Filter by provider: codex (default), claude, gemini, ollama, or 'all'")),
			), s.handleAgentList},
			{mcp.NewTool("ralphglasses_agent_compose",
				...
				mcp.WithString("provider", mcp.Description("Provider: codex (default), claude, gemini, ollama")),
	...
	return ToolGroup{
		...
		Tools: []ToolEntry{
			...
			{mcp.NewTool("ralphglasses_cost_estimate",
				...
				mcp.WithString("provider", mcp.Required(), mcp.Description("Provider: claude, gemini, codex, or ollama")),
