	...
	return ToolGroup{
		...
		Tools: []ToolEntry{
			{mcp.NewTool("ralphglasses_team_create",
				...
				mcp.WithString("execution_backend", mcp.Description("Worker execution backend: local or fleet")),
				...
				mcp.WithString("a2a_agent_url", mcp.Description("Reserved for future A2A support; ignored today")),
