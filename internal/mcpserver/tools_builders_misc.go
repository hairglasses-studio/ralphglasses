	...
	return ToolGroup{
		...
		Tools: []ToolEntry{
			...
			{mcp.NewTool("ralphglasses_rc_send",
				...
				mcp.WithString("provider", mcp.Description("Provider override: codex, claude, gemini, or auto/omit for runtime selection")),
			...
			{mcp.NewTool("ralphglasses_dispatch",
				...
				mcp.WithString("provider", mcp.Description("Provider override: claude, codex, gemini, or auto (default: auto; runtime selects when omitted)")),
			), s.handleDispatch},
	...
	return ToolGroup{
		...
		Tools: []ToolEntry{
			...
			{mcp.NewTool("ralphglasses_cost_estimate",
				...
				mcp.WithString("provider", mcp.Required(), mcp.Description("Provider: claude, gemini, codex")),
