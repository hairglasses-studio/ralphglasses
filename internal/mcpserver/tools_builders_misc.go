	...
	return ToolGroup{
		...
		Tools: []ToolEntry{
			{mcp.NewTool("ralphglasses_team_create",
				mcp.WithDescription("Create an agent team by `name` for `repo`; Codex teams use the structured autonomous runtime with planner/worker orchestration"),
	...
	return ToolGroup{
		...
		Tools: []ToolEntry{
			...
			{mcp.NewTool("ralphglasses_automation_policy",
				mcp.WithDescription("View, set, or recommend repo-local subscription-window automation policy for Codex pause/resume pacing."),
				mcp.WithString("repo", mcp.Required(), mcp.Description("Repo name")),
			...
			{mcp.NewTool("ralphglasses_automation_queue",
				mcp.WithDescription("Manage the durable queue for repo-local subscription-window automation."),
				mcp.WithString("repo", mcp.Required(), mcp.Description("Repo name")),
	...
	return ToolGroup{
		...
		Tools: []ToolEntry{
			...
			{mcp.NewTool("ralphglasses_provider_capabilities",
				mcp.WithDescription("Inspect the provider capability matrix for Claude, Codex, and Gemini, including native, emulated, and install-dependent features"),
			...
			{mcp.NewTool("ralphglasses_provider_compare",
				mcp.WithDescription("Compare Claude, Codex, and Gemini repo/runtime surfaces and optionally include task-specific recommendation data"),
