...
var configKeys = []ViewKeyEntry{
	...
	{Binding: func(km *KeyMap) key.Binding { return km.WriteConfig }, Handler: func(m *Model, _ tea.KeyPressMsg) (tea.Model, tea.Cmd) {
	...
	{Binding: func(km *KeyMap) key.Binding { return km.ConfigInsert }, Handler: func(m *Model, _ tea.KeyPressMsg) (tea.Model, tea.Cmd) {
		m.ConfigEdit.StartInsert()
		return *m, nil
	}},
	// Rename selected key (r)
	{Binding: func(km *KeyMap) key.Binding { return km.ConfigRename }, Handler: func(m *Model, _ tea.KeyPressMsg) (tea.Model, tea.Cmd) {
		m.ConfigEdit.StartRename()
		return *m, nil
	}},
	// Delete selected key (d or x)
	{Binding: func(km *KeyMap) key.Binding { return km.ConfigDelete }, Handler: func(m *Model, _ tea.KeyPressMsg) (tea.Model, tea.Cmd) {
		m.ConfigEdit.StartDelete()
		return *m, nil
	}},
	// Undo last operation (u)
	{Binding: func(km *KeyMap) key.Binding { return km.ConfigUndo }, Handler: func(m *Model, _ tea.KeyPressMsg) (tea.Model, tea.Cmd) {
...
func (m Model) handleConfigEditInput(msg tea.KeyPressMsg) (tea.Model, tea.Cmd) {
	if m.ConfigEdit == nil {
		return m, nil
	}
