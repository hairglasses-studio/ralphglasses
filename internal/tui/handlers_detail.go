...
var sessionDetailKeys = []ViewKeyEntry{
	...
	{Binding: func(km *KeyMap) key.Binding { return km.OutputView }, Handler: func(m *Model, _ tea.KeyPressMsg) (tea.Model, tea.Cmd) {
...
var teamDetailKeys = []ViewKeyEntry{
	...
	{Binding: func(km *KeyMap) key.Binding { return km.OrchestrationView }, Handler: func(m *Model, _ tea.KeyPressMsg) (tea.Model, tea.Cmd) {
		if m.Sel.TeamName != "" {
...
func (m Model) handleTeamOrchestrationKey(msg tea.KeyPressMsg) (tea.Model, tea.Cmd) {
...
var fleetKeys = []ViewKeyEntry{
	...
	{Match: func(msg tea.KeyPressMsg) bool { return msg.Key().Code == tea.KeyLeft }, Handler: func(m *Model, _ tea.KeyPressMsg) (tea.Model, tea.Cmd) {
		data := m.buildFleetData()
		m.cycleFleetSection(data, -1)
		return *m, nil
	}},
	{Match: func(msg tea.KeyPressMsg) bool { return msg.Key().Text == "]" }, Handler: func(m *Model, _ tea.KeyPressMsg) (tea.Model, tea.Cmd) {
...
func (m Model) handleSessionDetailKey(msg tea.KeyPressMsg) (tea.Model, tea.Cmd) {
...
func (m Model) handleTeamDetailKey(msg tea.KeyPressMsg) (tea.Model, tea.Cmd) {
...
func (m Model) handleTimelineKey(msg tea.KeyPressMsg) (tea.Model, tea.Cmd) {
