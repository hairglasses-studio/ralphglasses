---
name: user profile
description: Senior Go developer building the hairglasses-studio autonomous AI ecosystem — prefers parallel agents, ambitious batches, terse output
type: user
---
...
**Working style:**
- Prefers parallel worktree agents for multi-file changes
- Values speed through parallelism — 5-8 concurrent agents typical
- Terse communication style, no trailing summaries needed
- Comfortable approving large-scope changes
- Initiates research → plan → execute → verify cycles
