...
Always check ~/hairglasses-studio/docs/ for existing research before starting new work. Write reusable research outputs back to the shared docs repo (git: hairglasses-studio/docs) rather than local docs/.
